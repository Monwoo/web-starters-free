 ...
 */
final class Version20230625043038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billing_config ADD COLUMN hide_default_outlays_on_empty_outlays BOOLEAN DEFAULT NULL');
    }
