 ...
 */
final class Version20230625054609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE outlay ADD COLUMN insert_page_break_before BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE outlay ADD COLUMN provider_short_description CLOB DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__outlay AS SELECT id, provider_name, percent_on_business_total, provider_taxes, provider_details, provider_added_price, use_provider_added_price_for_business, provider_total_with_taxes_forseen_for_client FROM outlay');
