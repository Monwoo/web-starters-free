 ...
 */
final class Version20240207062559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mws_time_slot ADD COLUMN keywords CLOB DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__mws_time_slot AS SELECT id, source_time, source, range_day_idx_by10_min, range_day_idx_by_custom_norm, created_at, updated_at FROM mws_time_slot');
        ...
        $this->addSql('INSERT INTO mws_time_slot (id, source_time, source, range_day_idx_by10_min, range_day_idx_by_custom_norm, created_at, updated_at) SELECT id, source_time, source, range_day_idx_by10_min, range_day_idx_by_custom_norm, created_at, updated_at FROM __temp__mws_time_slot');
