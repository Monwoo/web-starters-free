 ...
 */
final class Version20230726031648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billing_config ADD COLUMN margin_after_end_item VARCHAR(255) DEFAULT NULL');
    }
