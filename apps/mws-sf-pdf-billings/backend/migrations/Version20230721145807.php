 ...
 */
final class Version20230721145807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billing_config ADD COLUMN document_type VARCHAR(255) DEFAULT NULL');
    }
